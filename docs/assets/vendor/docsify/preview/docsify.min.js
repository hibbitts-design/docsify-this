...
/**
  	 ...
  	 * @namespace
  	 * @public
  	 */e.exports&&(e.exports=n),void 0!==je&&(je.Prism=n),n.languages.markup={comment:{pattern:/<!--(?:(?!<!--)[\s\S])*?-->/,greedy:!0},prolog:{pattern:/<\?[\s\S]+?\?>/,greedy:!0},doctype:{pattern:/<!DOCTYPE(?:[^>"'[\]]|"[^"]*"|'[^']*')+(?:\[(?:[^<"'\]]|"[^"]*"|'[^']*'|<(?!!--)|<!--(?:[^-]|-(?!->))*-->)*\]\s*)?>/i,greedy:!0,inside:{"internal-subset":{pattern:/(^[^\[]*\[)[\s\S]+(?=\]>$)/,lookbehind:!0,greedy:!0,inside:null},string:{pattern:/"[^"]*"|'[^']*'/,greedy:!0},punctuation:/^<!|>$|[[\]]/,"doctype-tag":/^DOCTYPE/i,name:/[^\s<>'"]+/}},cdata:{pattern:/<!\[CDATA\[[\s\S]*?\]\]>/i,greedy:!0},tag:{pattern:/<\/?(?!\d)[^\s>\/=$<%]+(?:\s(?:\s*[^\s>\/=]+(?:\s*=\s*(?:"[^"]*"|'[^']*'|[^\s'">=]+(?=[\s>]))|(?=[\s/>])))+)?\s*\/?>/,greedy:!0,inside:{tag:{pattern:/^<\/?[^\s>\/]+/,inside:{punctuation:/^<\/?/,namespace:/^[^\s>\/:]+:/}},"special-attr":[],"attr-value":{pattern:/=\s*(?:"[^"]*"|'[^']*'|[^\s'">=]+)/,inside:{punctuation:[{pattern:/^=/,alias:"attr-equals"},{pattern:/^(\s*)["']|["']$/,lookbehind:!0}]}},punctuation:/\/?>/,"attr-name":{pattern:/[^\s>\/]+/,inside:{namespace:/^[^\s>\/:]+:/}}}},entity:[{pattern:/&[\da-z]{1,8};/i,alias:"named-entity"},/&#x?[\da-f]{1,8};/i]},n.languages.markup.tag.inside["attr-value"].inside.entity=n.languages.markup.entity,n.languages.markup.doctype.inside["internal-subset"].inside=n.languages.markup,n.hooks.add("wrap",(function(e){"entity"===e.type&&(e.attributes.title=e.content.replace(/&amp;/,"&"))})),Object.defineProperty(n.languages.markup.tag,"addInlined",{value:function(e,i){var t={};t["language-"+i]={pattern:/(^<!\[CDATA\[)[\s\S]+?(?=\]\]>$)/i,lookbehind:!0,inside:n.languages[i]},t.cdata=/^<!\[CDATA\[|\]\]>$/i;var o={"included-cdata":{pattern:/<!\[CDATA\[[\s\S]*?\]\]>/i,inside:t}};o["language-"+i]={pattern:/[\s\S]+/,inside:n.languages[i]};var a={};a[e]={pattern:RegExp(/(<__[^>]*>)(?:<!\[CDATA\[(?:[^\]]|\](?!\]>))*\]\]>|(?!<!\[CDATA\[)[\s\S])*?(?=<\/__>)/.source.replace(/__/g,(function(){return e})),"i"),lookbehind:!0,greedy:!0,inside:o},n.languages.insertBefore("markup","cdata",a)}}),Object.defineProperty(n.languages.markup.tag,"addAttribute",{value:function(e,i){n.languages.markup.tag.inside["special-attr"].push({pattern:RegExp(/(^|["'\s])/.source+"(?:"+e+")"+/\s*=\s*(?:"[^"]*"|'[^']*'|[^\s'">=]+(?=[\s>]))/.source,"i"),lookbehind:!0,inside:{"attr-name":/^[^\s=]+/,"attr-value":{pattern:/=[\s\S]+/,inside:{value:{pattern:/(^=\s*(["']|(?!["'])))\S[\s\S]*(?=\2$)/,lookbehind:!0,alias:[i,"language-"+i],inside:n.languages[i]},punctuation:[{pattern:/^=/,alias:"attr-equals"},/"|'/]}}}})}}),n.languages.html=n.languages.markup,n.languages.mathml=n.languages.markup,n.languages.svg=n.languages.markup,n.languages.xml=n.languages.extend("markup",{}),n.languages.ssml=n.languages.xml,n.languages.atom=n.languages.xml,n.languages.rss=n.languages.xml,function(e){var n=/(?:"(?:\\(?:\r\n|[\s\S])|[^"\\\r\n])*"|'(?:\\(?:\r\n|[\s\S])|[^'\\\r\n])*')/;e.languages.css={comment:/\/\*[\s\S]*?\*\//,atrule:{pattern:RegExp("@[\\w-](?:"+/[^;{\s"']|\s+(?!\s)/.source+"|"+n.source+")*?"+/(?:;|(?=\s*\{))/.source),inside:{rule:/^@[\w-]+/,"selector-function-argument":{pattern:/(\bselector\s*\(\s*(?![\s)]))(?:[^()\s]|\s+(?![\s)])|\((?:[^()]|\([^()]*\))*\))+(?=\s*\))/,lookbehind:!0,alias:"selector"},keyword:{pattern:/(^|[^\w-])(?:and|not|only|or)(?![\w-])/,lookbehind:!0}}},url:{pattern:RegExp("\\burl\\((?:"+n.source+"|"+/(?:[^\\\r\n()"']|\\[\s\S])*/.source+")\\)","i"),greedy:!0,inside:{function:/^url/i,punctuation:/^\(|\)$/,string:{pattern:RegExp("^"+n.source+"$"),alias:"url"}}},selector:{pattern:RegExp("(^|[{}\\s])[^{}\\s](?:[^{};\"'\\s]|\\s+(?![\\s{])|"+n.source+")*(?=\\s*\\{)"),lookbehind:!0},string:{pattern:n,greedy:!0},property:{pattern:/(^|[^-\w\xA0-\uFFFF])(?!\s)[-_a-z\xA0-\uFFFF](?:(?!\s)[-\w\xA0-\uFFFF])*(?=\s*:)/i,lookbehind:!0},important:/!important\b/i,function:{pattern:/(^|[^-a-z0-9])[-a-z0-9]+(?=\()/i,lookbehind:!0},punctuation:/[(){};:,]/},e.languages.css.atrule.inside.rest=e.languages.css;var i=e.languages.markup;i&&(i.tag.addInlined("style","css"),i.tag.addAttribute("style","css"))}(n),n.languages.clike={comment:[{pattern:/(^|[^\\])\/\*[\s\S]*?(?:\*\/|$)/,lookbehind:!0,greedy:!0},{pattern:/(^|[^\\:])\/\/.*/,lookbehind:!0,greedy:!0}],string:{pattern:/(["'])(?:\\(?:\r\n|[\s\S])|(?!\1)[^\\\r\n])*\1/,greedy:!0},"class-name":{pattern:/(\b(?:class|extends|implements|instanceof|interface|new|trait)\s+|\bcatch\s+\()[\w.\\]+/i,lookbehind:!0,inside:{punctuation:/[.\\]/}},keyword:/\b(?:break|catch|continue|do|else|finally|for|function|if|in|instanceof|new|null|return|throw|try|while)\b/,boolean:/\b(?:false|true)\b/,function:/\b\w+(?=\()/,number:/\b0x[\da-f]+\b|(?:\b\d+(?:\.\d*)?|\B\.\d+)(?:e[+-]?\d+)?/i,operator:/[<>]=?|[!=]=?=?|--?|\+\+?|&&?|\|\|?|[?*/~^%]/,punctuation:/[{}[\];(),.:]/},n.languages.javascript=n.languages.extend("clike",{"class-name":[n.languages.clike["class-name"],{pattern:/(^|[^$\w\xA0-\uFFFF])(?!\s)[_$A-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\.(?:constructor|prototype))/,lookbehind:!0}],keyword:[{pattern:/((?:^|\})\s*)catch\b/,lookbehind:!0},{pattern:/(^|[^.]|\.\.\.\s*)\b(?:as|assert(?=\s*\{)|async(?=\s*(?:function\b|\(|[$\w\xA0-\uFFFF]|$))|await|break|case|class|const|continue|debugger|default|delete|do|else|enum|export|extends|finally(?=\s*(?:\{|$))|for|from(?=\s*(?:['"]|$))|function|(?:get|set)(?=\s*(?:[#\[$\w\xA0-\uFFFF]|$))|if|implements|import|in|instanceof|interface|let|new|null|of|package|private|protected|public|return|static|super|switch|this|throw|try|typeof|undefined|var|void|while|with|yield)\b/,lookbehind:!0}],function:/#?(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\s*(?:\.\s*(?:apply|bind|call)\s*)?\()/,number:{pattern:RegExp(/(^|[^\w$])/.source+"(?:"+/NaN|Infinity/.source+"|"+/0[bB][01]+(?:_[01]+)*n?/.source+"|"+/0[oO][0-7]+(?:_[0-7]+)*n?/.source+"|"+/0[xX][\dA-Fa-f]+(?:_[\dA-Fa-f]+)*n?/.source+"|"+/\d+(?:_\d+)*n/.source+"|"+/(?:\d+(?:_\d+)*(?:\.(?:\d+(?:_\d+)*)?)?|\.\d+(?:_\d+)*)(?:[Ee][+-]?\d+(?:_\d+)*)?/.source+")"+/(?![\w$])/.source),lookbehind:!0},operator:/--|\+\+|\*\*=?|=>|&&=?|\|\|=?|[!=]==|<<=?|>>>?=?|[-+*/%&|^!=<>]=?|\.{3}|\?\?=?|\?\.?|[~:]/}),n.languages.javascript["class-name"][0].pattern=/(\b(?:class|extends|implements|instanceof|interface|new)\s+)[\w.\\]+/,n.languages.insertBefore("javascript","keyword",{regex:{pattern:RegExp(/((?:^|[^$\w\xA0-\uFFFF."'\])\s]|\b(?:return|yield))\s*)/.source+/\//.source+"(?:"+/(?:\[(?:[^\]\\\r\n]|\\.)*\]|\\.|[^/\\\[\r\n])+\/[dgimyus]{0,7}/.source+"|"+/(?:\[(?:[^[\]\\\r\n]|\\.|\[(?:[^[\]\\\r\n]|\\.|\[(?:[^[\]\\\r\n]|\\.)*\])*\])*\]|\\.|[^/\\\[\r\n])+\/[dgimyus]{0,7}v[dgimyus]{0,7}/.source+")"+/(?=(?:\s|\/\*(?:[^*]|\*(?!\/))*\*\/)*(?:$|[\r\n,.;:})\]]|\/\/))/.source),lookbehind:!0,greedy:!0,inside:{"regex-source":{pattern:/^(\/)[\s\S]+(?=\/[a-z]*$)/,lookbehind:!0,alias:"language-regex",inside:n.languages.regex},"regex-delimiter":/^\/|\/$/,"regex-flags":/^[a-z]+$/}},"function-variable":{pattern:/#?(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\s*[=:]\s*(?:async\s*)?(?:\bfunction\b|(?:\((?:[^()]|\([^()]*\))*\)|(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*)\s*=>))/,alias:"function"},parameter:[{pattern:/(function(?:\s+(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*)?\s*\(\s*)(?!\s)(?:[^()\s]|\s+(?![\s)])|\([^()]*\))+(?=\s*\))/,lookbehind:!0,inside:n.languages.javascript},{pattern:/(^|[^$\w\xA0-\uFFFF])(?!\s)[_$a-z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\s*=>)/i,lookbehind:!0,inside:n.languages.javascript},{pattern:/(\(\s*)(?!\s)(?:[^()\s]|\s+(?![\s)])|\([^()]*\))+(?=\s*\)\s*=>)/,lookbehind:!0,inside:n.languages.javascript},{pattern:/((?:\b|\s|^)(?!(?:as|async|await|break|case|catch|class|const|continue|debugger|default|delete|do|else|enum|export|extends|finally|for|from|function|get|if|implements|import|in|instanceof|interface|let|new|null|of|package|private|protected|public|return|set|static|super|switch|this|throw|try|typeof|undefined|var|void|while|with|yield)(?![$\w\xA0-\uFFFF]))(?:(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*\s*)\(\s*|\]\s*\(\s*)(?!\s)(?:[^()\s]|\s+(?![\s)])|\([^()]*\))+(?=\s*\)\s*\{)/,lookbehind:!0,inside:n.languages.javascript}],constant:/\b[A-Z](?:[A-Z_]|\dx?)*\b/}),n.languages.insertBefore("javascript","string",{hashbang:{pattern:/^#!.*/,greedy:!0,alias:"comment"},"template-string":{pattern:/`(?:\\[\s\S]|\$\{(?:[^{}]|\{(?:[^{}]|\{[^}]*\})*\})+\}|(?!\$\{)[^\\`])*`/,greedy:!0,inside:{"template-punctuation":{pattern:/^`|`$/,alias:"string"},interpolation:{pattern:/((?:^|[^\\])(?:\\{2})*)\$\{(?:[^{}]|\{(?:[^{}]|\{[^}]*\})*\})+\}/,lookbehind:!0,inside:{"interpolation-punctuation":{pattern:/^\$\{|\}$/,alias:"punctuation"},rest:n.languages.javascript}},string:/[\s\S]+/}},"string-property":{pattern:/((?:^|[,{])[ \t]*)(["'])(?:\\(?:\r\n|[\s\S])|(?!\2)[^\\\r\n])*\2(?=\s*:)/m,lookbehind:!0,greedy:!0,alias:"property"}}),n.languages.insertBefore("javascript","operator",{"literal-property":{pattern:/((?:^|[,{])[ \t]*)(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\s*:)/m,lookbehind:!0,alias:"property"}}),n.languages.markup&&(n.languages.markup.tag.addInlined("script","javascript"),n.languages.markup.tag.addAttribute(/on(?:abort|blur|change|click|composition(?:end|start|update)|dblclick|error|focus(?:in|out)?|key(?:down|up)|load|mouse(?:down|enter|leave|move|out|over|up)|reset|resize|scroll|select|slotchange|submit|unload|wheel)/.source,"javascript")),n.languages.js=n.languages.javascript,function(){if(void 0!==n&&"undefined"!=typeof document){Element.prototype.matches||(Element.prototype.matches=Element.prototype.msMatchesSelector||Element.prototype.webkitMatchesSelector);var e={js:"javascript",py:"python",rb:"ruby",ps1:"powershell",psm1:"powershell",sh:"bash",bat:"batch",h:"c",tex:"latex"},i="data-src-status",t="loading",o="loaded",a="pre[data-src]:not(["+i+'="'+o+'"]):not(['+i+'="'+t+'"])';n.hooks.add("before-highlightall",(function(e){e.selector+=", "+a})),n.hooks.add("before-sanity-check",(function(c){var r=c.element;if(r.matches(a)){c.code="",r.setAttribute(i,t);var s=r.appendChild(document.createElement("CODE"));s.textContent="Loading…";var u=r.getAttribute("data-src"),d=c.language;if("none"===d){var f=(/\.(\w+)$/.exec(u)||[,"none"])[1];d=e[f]||f}n.util.setLanguage(s,d),n.util.setLanguage(r,d);var g=n.plugins.autoloader;g&&g.loadLanguages(d),function(e,n,i){var t=new XMLHttpRequest;t.open("GET",e,!0),t.onreadystatechange=function(){4==t.readyState&&(t.status<400&&t.responseText?n(t.responseText):t.status>=400?i("✖ Error "+t.status+" while fetching file: "+t.statusText):i("✖ Error: File does not exist or is empty"))},t.send(null)}(u,(function(e){r.setAttribute(i,o);var t=function(e){var n=/^\s*(\d+)\s*(?:(,)\s*(?:(\d+)\s*)?)?$/.exec(e||"");if(n){var i=Number(n[1]),t=n[2],o=n[3];return t?o?[i,Number(o)]:[i,void 0]:[i,i]}}(r.getAttribute("data-range"));if(t){var a=e.split(/\r\n?|\n/g),c=t[0],u=null==t[1]?a.length:t[1];c<0&&(c+=a.length),c=Math.max(0,Math.min(c-1,a.length)),u<0&&(u+=a.length),u=Math.max(0,Math.min(u,a.length)),e=a.slice(c,u).join("\n"),r.hasAttribute("data-start")||r.setAttribute("data-start",String(c+1))}s.textContent=e,n.highlightElement(s)}),(function(e){r.setAttribute(i,"failed"),s.textContent=e}))}})),n.plugins.fileHighlight={highlight:function(e){for(var i,t=(e||document).querySelectorAll(a),o=0;i=t[o++];)n.highlightElement(i)}};var c=!1;n.fileHighlight=function(){c||(console.warn("Prism.fileHighlight is deprecated. Use `Prism.plugins.fileHighlight.highlight` instead."),c=!0),n.plugins.fileHighlight.highlight.apply(this,arguments)}}}()}(qe);var Pe=Oe(qe.exports);!function(e){function n(e,n){return"___"+e.toUpperCase()+n+"___"}Object.defineProperties(e.languages["markup-templating"]={},{buildPlaceholders:{value:function(i,t,o,a){if(i.language===t){var c=i.tokenStack=[];i.code=i.code.replace(o,(function(e){if("function"==typeof a&&!a(e))return e;for(var o,r=c.length;-1!==i.code.indexOf(o=n(t,r));)++r;return c[r]=e,o})),i.grammar=e.languages.markup}}},tokenizePlaceholders:{value:function(i,t){if(i.language===t&&i.tokenStack){i.grammar=e.languages[t];var o=0,a=Object.keys(i.tokenStack);!function c(r){for(var s=0;s<r.length&&!(o>=a.length);s++){var u=r[s];if("string"==typeof u||u.content&&"string"==typeof u.content){var d=a[o],f=i.tokenStack[d],g="string"==typeof u?u:u.content,p=n(t,d),l=g.indexOf(p);if(l>-1){++o;var v=g.substring(0,l),h=new e.Token(t,e.tokenize(f,i.grammar),"language-"+t,f),_=g.substring(l+p.length),m=[];v&&m.push.apply(m,c([v])),m.push(h),_&&m.push.apply(m,c([_])),"string"==typeof u?r.splice.apply(r,[s,1].concat(m)):u.content=m}}else u.content&&c(u.content)}return r}(i.tokens)}}}})}(Prism);const Me={},Ie={markdown:e=>({url:e}),mermaid:e=>({url:e}),iframe:(e,n)=>({html:`<iframe src="${e}" ${n||"width=100% height=400"}></iframe>`}),video:(e,n)=>({html:`<video src="${e}" ${n||"controls"}>Not Support</video>`}),audio:(e,n)=>({html:`<audio src="${e}" ${n||"controls"}>Not Support</audio>`}),code(e,n){let i=e.match(/\.(\w+)$/);return i=n||i&&i[1],"md"===i&&(i="markdown"),{url:e,lang:i}}};class Ne{constructor(n,t){this.config=n,this.router=t,this.cacheTree={},this.toc=[],this.cacheTOC={},this.linkTarget=n.externalLinkTarget||"_blank",this.linkRel="_blank"===this.linkTarget?n.externalLinkRel||"noopener":"",this.contentBase=t.getBasePath();const a=this._initRenderer();let c;this.heading=a.heading;const r=n.markdown||{};o(r)?c=r(xe,a):(xe.setOptions(Object.assign(r,{renderer:Object.assign(a,r.renderer)})),c=xe),this._marked=c,this.compile=t=>{let o=!0;const a=e((e=>{o=!1;let a="";return t?(a=i(t)?c(t):c.parser(t),a=n.noEmoji?a:Ce(a,n.nativeEmoji),Le.clear(),a):t}))(t),r=this.router.parse().file;return o?this.toc=this.cacheTOC[r]:this.cacheTOC[r]=[...this.toc],a}}compileEmbed(e,n){const{str:i,config:t}=Re(n);let o;if(n=i,t.include){let i;if(A(e)||(e=F(this.contentBase,z(this.router.getCurrentPath()),e)),t.type&&(i=Ie[t.type]))o=i.call(this,e,n),o.type=t.type;else{let i="code";/\.(md|markdown)/.test(e)?i="markdown":/\.mmd/.test(e)?i="mermaid":/\.html?/.test(e)?i="iframe":/\.(mp4|ogg)/.test(e)?i="video":/\.mp3/.test(e)&&(i="audio"),o=Ie[i].call(this,e,n),o.type=i}return o.fragment=t.fragment,o}}_matchNotCompileLink(e){const n=this.config.noCompileLinks||[];for(const i of n){if((Me[i]||(Me[i]=new RegExp(`^${i}$`))).test(e))return e}}_initRenderer(){const e=new xe.Renderer,{linkTarget:n,linkRel:i,router:t,contentBase:o}=this,a=this,c={};return c.heading=e.heading=function(e,n){let{str:i,config:o}=Re(e);const c={level:n,title:i},{content:r,ignoreAllSubs:s,ignoreSubHeading:u}=function(e=""){let n,i;return/<!-- {docsify-ignore} -->/g.test(e)&&(e=e.replace("\x3c!-- {docsify-ignore} --\x3e",""),i=!0),/{docsify-ignore}/g.test(e)&&(e=e.replace("{docsify-ignore}",""),i=!0),/<!-- {docsify-ignore-all} -->/g.test(e)&&(e=e.replace("\x3c!-- {docsify-ignore-all} --\x3e",""),n=!0),/{docsify-ignore-all}/g.test(e)&&(e=e.replace("{docsify-ignore-all}",""),n=!0),{content:e,ignoreAllSubs:n,ignoreSubHeading:i}}(i);i=r.trim(),c.title=function(e=""){return e.replace(/(<\/?a.*?>)/gi,"")}(i),c.ignoreAllSubs=s,c.ignoreSubHeading=u;const d=Le(o.id||i),f=t.toURL(t.getCurrentPath(),{id:d});return c.slug=f,a.toc.push(c),`<h${n} id="${d}" tabindex="-1"><a href="${f}" data-id="${d}" class="anchor"><span>${i}</span></a></h${n}>`},c.code=(({renderer:e})=>e.code=function(e,n="markup"){const i=Pe.languages[n]||Pe.languages.markup;return`<pre v-pre data-lang="${n}"><code class="lang-${n}" tabindex="0">${Pe.highlight(e.replace(/@DOCSIFY_QM@/g,"`"),i,n)}</code></pre>`})({renderer:e}),c.link=(({renderer:e,router:n,linkTarget:i,linkRel:t,compilerClass:o})=>e.link=(e,a="",c)=>{let r=[];const{str:s,config:u}=Re(a);return i=u.target||i,t="_blank"===i?o.config.externalLinkRel||"noopener":"",a=s,A(e)||o._matchNotCompileLink(e)||u.ignore?(A(e)||"./"!==e.slice(0,2)||(e=document.URL.replace(/\/(?!.*\/).*/,"/").replace("#/./","")+e),r.push(0===e.indexOf("mailto:")?"":`target="${i}"`),r.push(0===e.indexOf("mailto:")?"":""!==t?` rel="${t}"`:"")):(e===o.config.homepage&&(e="README"),e=n.toURL(e,null,n.getCurrentPath())),u.disabled&&(r.push("disabled"),e="javascript:void(0)"),u.class&&r.push(`class="${u.class}"`),u.id&&r.push(`id="${u.id}"`),a&&r.push(`title="${a}"`),`<a href="${e}" ${r.join(" ")}>${c}</a>`})({renderer:e,router:t,linkTarget:n,linkRel:i,compilerClass:a}),c.paragraph=(({renderer:e})=>e.paragraph=e=>{let n;return n=/^!&gt;/.test(e)?Ae("tip",e):/^\?&gt;/.test(e)?Ae("warn",e):`<p>${e}</p>`,n})({renderer:e}),c.image=(({renderer:e,contentBase:n,router:i})=>e.image=(e,t,o)=>{let a=e,c=[];const{str:r,config:s}=Re(t);if(t=r,s["no-zoom"]&&c.push("data-no-zoom"),t&&c.push(`title="${t}"`),s.size){const[e,n]=s.size.split("x");n?c.push(`width="${e}" height="${n}"`):c.push(`width="${e}"`)}return s.class&&c.push(`class="${s.class}"`),s.id&&c.push(`id="${s.id}"`),A(e)||(a=F(n,z(i.getCurrentPath()),e)),`<img src="${a}" data-origin="${e}" alt="${o}" ${c.join(" ")} />`})({renderer:e,contentBase:o,router:t}),c.list=(({renderer:e})=>e.list=(e,n,i)=>{const t=n?"ol":"ul";return`<${t} ${[/<li class="task-list-item">/.test(e.split('class="task-list"')[0])?'class="task-list"':"",i&&i>1?`start="${i}"`:""].join(" ").trim()}>${e}</${t}>`})({renderer:e}),c.listitem=(({renderer:e})=>e.listitem=e=>/^(<input.*type="checkbox"[^>]*>)/.test(e)?`<li class="task-list-item"><label>${e}</label></li>`:`<li>${e}</li>`)({renderer:e}),e.origin=c,e}sidebar(e,n){const{toc:i}=this,t=this.router.getCurrentPath();let o="";if(e)o=this.compile(e);else{for(let e=0;e<i.length;e++)if(i[e].ignoreSubHeading){const n=i[e].level;i.splice(e,1);for(let t=e;t<i.length&&n<i[t].level;t++)i.splice(t,1)&&t--&&e++;e--}const e=this.cacheTree[t]||Se(i,n);o=$e(e,"<ul>{inner}</ul>"),this.cacheTree[t]=e}return o}subSidebar(e){if(!e)return void(this.toc=[]);const n=this.router.getCurrentPath(),{cacheTree:i,toc:t}=this;t[0]&&t[0].ignoreAllSubs&&t.splice(0),t[0]&&1===t[0].level&&t.shift();for(let e=0;e<t.length;e++)t[e].ignoreSubHeading&&t.splice(e,1)&&e--;const o=i[n]||Se(t,e);return i[n]=o,this.toc=[],$e(o)}header(e,n){return this.heading(e,n)}article(e){return this.compile(e)}cover(e){const n=this.toc.slice(),i=this.compile(e);return this.toc=n.slice(),i}}const De=e=>{const n=e.match(/^[ \t]*(?=\S)/gm);return n?n.reduce(((e,n)=>Math.min(e,n.length)),1/0):0};var He=Oe((e=>{const n=De(e);if(0===n)return e;const i=new RegExp(`^[ \\t]{${n}}`,"gm");return e.replace(i,"")}));let Be,Ue;function Ze(e){const{loaded:n,total:i,step:t}=e;let o;!Be&&function(){const e=l("div");e.classList.add("progress"),e.setAttribute("role","progressbar"),e.setAttribute("aria-valuemin","0"),e.setAttribute("aria-valuemax","100"),e.setAttribute("aria-label","Loading..."),v(d,e),Be=e}(),void 0!==t?(o=parseInt(Be.style.width||0,10)+t,o=o>80?80:o):o=Math.floor(n/i*100),Be.style.opacity=1,Be.style.width=o>=95?"100%":o+"%",Be.setAttribute("aria-valuenow",o>=95?100:o),o>=95&&(clearTimeout(Ue),Ue=setTimeout((e=>{Be.style.opacity=0,Be.style.width="0%",Be.removeAttribute("aria-valuenow")}),200))}const Ve={};function Qe(e,n=!1,i={}){const o=new XMLHttpRequest,a=Ve[e];if(a)return{then:e=>e(a.content,a.opt),abort:t};o.open("GET",e);for(const e of Object.keys(i))o.setRequestHeader(e,i[e]);return o.send(),{then(i,a=t){const c=e=>({ok:e.target.status>=200&&e.target.status<300,status:e.target.status,statusText:e.target.statusText});if(n){const e=setInterval((e=>Ze({step:Math.floor(5*Math.random()+1)})),500);o.addEventListener("progress",Ze),o.addEventListener("loadend",(n=>{Ze(n),clearInterval(e)}))}o.addEventListener("error",(e=>{a(e,c(e))})),o.addEventListener("load",(n=>{const t=n.target;if(t.status>=400)a(n,c(n));else{if("string"!=typeof t.response)throw new TypeError("Unsupported content type.");const a=Ve[e]={content:t.response,opt:{updatedAt:o.getResponseHeader("last-modified")??""}};i(a.content,a.opt,c(n))}}))},abort:e=>4!==o.readyState&&o.abort()}}const We={};function Ge({compiler:e,raw:n="",fetch:i},t){let o=We[n];if(o){const e=o.slice();return e.links=o.links,t(e)}const a=e._marked;let c=a.lexer(n);const r=[],s=a.Lexer.rules.inline.link,u=c.links;c.forEach(((n,i)=>{"paragraph"===n.type&&(n.text=n.text.replace(new RegExp(s.source,"g"),((n,t,o,a)=>{const c=e.compileEmbed(o,a);return c&&r.push({index:i,embed:c}),n})))}));const d=[];!function({embedTokens:e,compile:n,fetch:i},t){let o,a=0,c=0;if(!e.length)return t({});for(;o=e[a++];){const i=o,a=o=>{let a;if(o)if("markdown"===i.embed.type){let e=i.embed.url.split("/");e.pop(),e=e.join("/"),o=o.replace(/\[([^[\]]+)\]\(([^)]+)\)/g,(n=>{const i=n.indexOf("(");return"(."===n.slice(i,i+2)?n.substring(0,i)+`(${window.location.protocol}//${window.location.host}${e}/`+n.substring(i+1,n.length-1)+")":n})),!0===(($docsify.frontMatter||{}).installed||!1)&&(o=$docsify.frontMatter.parseMarkdown(o)),a=n.lexer(o)}else if("code"===i.embed.type){if(i.embed.fragment){const e=i.embed.fragment,n=new RegExp(`(?:###|\\/\\/\\/)\\s*\\[${e}\\]([\\s\\S]*)(?:###|\\/\\/\\/)\\s*\\[${e}\\]`);o=He((o.match(n)||[])[1]||"").trim()}a=n.lexer("```"+i.embed.lang+"\n"+o.replace(/`/g,"@DOCSIFY_QM@")+"\n```\n")}else"mermaid"===i.embed.type?(a=[{type:"html",text:`<div class="mermaid">\n${o}\n</div>`}],a.links={}):(a=[{type:"html",text:o}],a.links={});t({token:i,embedToken:a}),++c>=e.length&&t({})};o.embed.url?Qe(o.embed.url).then(a):a(o.embed.html)}}({compile:a,embedTokens:r,fetch:i},(({embedToken:e,token:i})=>{if(i){let n=i.index;d.forEach((e=>{n>e.start&&(n+=e.length)})),Object.assign(u,e.links),c=c.slice(0,n).concat(e,c.slice(n+1)),d.push({start:n,length:e.length-1})}else We[n]=c.concat(),c.links=We[n].links=u,t(c)}))}function Ye(e){return class extends e{#t;#o(e){p(e).forEach((e=>{!e.title&&e.innerText&&(e.title=e.innerText)}))}#a(){const e=p(".markdown-section>script").filter((e=>!/template/.test(e.type)))[0];if(!e)return!1;const n=e.innerText.trim();if(!n)return!1;new Function(n)()}#c(e,n,i){var t,o,a,c;return n="function"==typeof i?i(n):"string"==typeof i?(a=[],c=0,(t=i).replace(M,(function(e,n,i){a.push(t.substring(c,i-1)),c=i+=e.length+1,a.push(o&&o[e]||function(n){return("00"+("string"==typeof I[e]?n[I[e]]():I[e](n))).slice(-e.length)})})),c!==t.length&&a.push(t.substring(c)),function(e){for(var n="",i=0,t=e||new Date;i<a.length;i++)n+="string"==typeof a[i]?a[i]:a[i](t);return n})(new Date(n)):n,e.replace(/{docsify-updated}/g,n)}#r(e){const n=this.config,i=g(".markdown-section"),t="Vue"in window&&window.Vue.version&&Number(window.Vue.version.charAt(0)),o=e=>{const n=Boolean(e.__vue__&&e.__vue__._isVue),i=Boolean(e._vnode&&e._vnode.__v_skip);return n||i};if("Vue"in window){const e=p(".markdown-section > *").filter((e=>o(e)));for(const n of e)2===t?n.__vue__.$destroy():3===t&&n.__vue_app__.unmount()}if(this._renderTo(i,e),!n.loadSidebar&&this._renderSidebar(),(n.executeScript||"Vue"in window&&!1!==n.executeScript)&&this.#a(),"Vue"in window){const e=n.vueGlobalOptions||{},a=[],c=Object.keys(n.vueComponents||{});2===t&&c.length&&c.forEach((e=>{!window.Vue.options.components[e]&&window.Vue.component(e,n.vueComponents[e])})),!this.#t&&e.data&&"function"==typeof e.data&&(this.#t=e.data()),a.push(...Object.keys(n.vueMounts||{}).map((e=>[g(i,e),n.vueMounts[e]])).filter((([e,n])=>e)));const r=/{{2}[^{}]*}{2}/,s=/<[^>/]+\s([@:]|v-)[\w-:.[\]]+[=>\s]/;if(a.push(...p(".markdown-section > *").filter((e=>!a.some((([n,i])=>n===e)))).filter((e=>e.tagName.toLowerCase()in(n.vueComponents||{})||e.querySelector(c.join(",")||null)||r.test(e.outerHTML)||s.test(e.outerHTML))).map((n=>{const i={...e};return this.#t&&(i.data=()=>this.#t),[n,i]}))),0===a.length)return;for(const[e,i]of a){const a="data-isvue";if(!(e.matches("pre, script")||o(e)||e.querySelector(`[${a}]`)))if(e.setAttribute(a,""),2===t)i.el=void 0,new window.Vue(i).$mount(e);else if(3===t){const t=window.Vue.createApp(i);c.forEach((e=>{const i=n.vueComponents[e];t.component(e,i)})),t.mount(e)}}}}#s(e){const n=s(".app-name-link"),t=e.config.nameLink,o=e.route.path;if(n)if(i(e.config.nameLink))n.setAttribute("href",t);else if("object"==typeof t){const e=Object.keys(t).filter((e=>o.indexOf(e)>-1))[0];n.setAttribute("href",t[e])}}#u(e){const{skipLink:n}=e.config;if(!1!==n){const i=s("#skip-to-content");let t="string"==typeof n?n:"Skip to main content";if(n?.constructor===Object){const i=Object.keys(n).find((n=>e.route.path.startsWith(n.startsWith("/")?n:`/${n}`)));t=i&&n[i]||t}if(i)i.innerHTML=t;else{const e=`<button id="skip-to-content">${t}</button>`;d.insertAdjacentHTML("afterbegin",e)}}}_renderTo(e,n,i){const t=s(e);t&&(t[i?"outerHTML":"innerHTML"]=n)}_renderSidebar(e){const{maxLevel:n,subMaxLevel:i,loadSidebar:t,hideSidebar:o}=this.config,a=s("aside.sidebar"),r=s("button.sidebar-toggle");if(o)return d.classList.add("hidesidebar"),a?.remove(a),r?.remove(r),null;this._renderTo(".sidebar-nav",this.compiler.sidebar(e,n)),r.setAttribute("aria-expanded",!c);const u=g(`.sidebar-nav a[href="${this.router.toURL(this.route.path)}"]`);this.#o(".sidebar-nav a"),t&&u?u.parentNode.innerHTML+=this.compiler.subSidebar(i)||"":this.compiler.subSidebar(),this._bindEventOnRendered(u)}_bindEventOnRendered(e){const{autoHeader:n}=this.config;if(this.onRender(),n&&e){const n=s("#main"),i=n.children[0];if(i&&"H1"!==i.tagName){h(n,l("div",this.compiler.header(e.innerText,1)).children[0])}}}_renderNav(e){e&&this._renderTo("nav",this.compiler.compile(e)),this.#o("nav a")}_renderMain(e,n={},i){const{response:t}=this.route;!t||t.ok||e&&404===t.status||(e=`# ${t.status} - ${t.statusText}`),this.callHook("beforeEach",e,(t=>{let o;const a=()=>{n.updatedAt&&(o=this.#c(o,n.updatedAt,this.config.formatUpdated)),this.callHook("afterEach",o,(e=>{this.#r(e),i()}))};this.isHTML?(o=this.result=e,a()):Ge({compiler:this.compiler,raw:t},(e=>{o=this.compiler.compile(e),a()}))}))}_renderCover(e,n){const i=s(".cover");if(m(s("main"),n?"add":"remove","hidden"),!e)return void m(i,"remove","show");m(i,"add","show");let t=this.coverIsHTML?e:this.compiler.cover(e);const o=t.trim().match('<p><img.*?data-origin="(.*?)"[^a]+alt="(.*?)">([^<]*?)</p>$');if(o){if("color"===o[2])i.style.background=o[1]+(o[3]||"");else{let e=o[1];m(i,"add","has-mask"),A(o[1])||(e=F(this.router.getBasePath(),o[1])),i.style.backgroundImage=`url(${e})`,i.style.backgroundSize="cover",i.style.backgroundPosition="center center"}t=t.replace(o[0],"")}this._renderTo(".cover-main",t)}_updateRender(){this.#s(this),this.#u(this)}initRender(){const e=this.config;this.compiler=new Ne(e,this.router),window.__current_docsify_compiler__=this.compiler;const n=g(e.el||"#app");if(n){let o="";if(e.repo&&(o+=(i=e.repo,t=e.cornerExternalLinkTarget,i?(/\/\//.test(i)||(i="https://github.com/"+i),`\n    <a href="${i=i.replace(/^git\+/,"")}" target="${t=t||"_blank"}" class="github-corner" aria-label="View source on Github">\n      <svg viewBox="0 0 250 250" aria-hidden="true">\n        <path d="M0,0 L115,115 L130,115 L142,142 L250,250 L250,0 Z"></path>\n        <path d="M128.3,109.0 C113.8,99.7 119.0,89.6 119.0,89.6 C122.0,82.7 120.5,78.6 120.5,78.6 C119.2,72.0 123.4,76.3 123.4,76.3 C127.3,80.9 125.5,87.3 125.5,87.3 C122.9,97.6 130.6,101.9 134.4,103.2" fill="currentColor" style="transform-origin: 130px 106px;" class="octo-arm"></path>\n        <path d="M115.0,115.0 C114.9,115.1 118.7,116.5 119.8,115.4 L133.7,101.6 C136.9,99.2 139.9,98.4 142.2,98.6 C133.8,88.0 127.5,74.4 143.8,58.0 C148.5,53.4 154.0,51.2 159.7,51.0 C160.3,49.4 163.2,43.6 171.4,40.1 C171.4,40.1 176.1,42.5 178.8,56.2 C183.1,58.6 187.2,61.8 190.9,65.4 C194.5,69.0 197.7,73.2 200.1,77.6 C213.8,80.2 216.3,84.9 216.3,84.9 C212.7,93.1 206.9,96.0 205.4,96.6 C205.1,102.4 203.0,107.8 198.3,112.5 C181.9,128.9 168.3,122.5 157.7,114.1 C157.9,116.9 156.7,120.9 152.7,124.9 L141.0,136.5 C139.8,137.7 141.6,141.9 141.8,141.8 Z" fill="currentColor" class="octo-body"></path>\n      </svg>\n    </a>\n  `):"")),e.coverpage&&(o+=function(){const e=", 100%, 85%";return`\n    <section class="cover show" role="complementary" aria-label="cover" style="background: \n    linear-gradient(\n      to left bottom,\n      hsl(${Math.floor(255*Math.random())+e}) 0%,\n      hsl(${Math.floor(255*Math.random())+e}) 100%\n    )\n  ">\n      <div class="mask"></div>\n      <div class="cover-main">\x3c!--cover--\x3e</div>\n    </section>\n  `}()),e.logo){const n=/^data:image/.test(e.logo),i=/(?:http[s]?:)?\/\//.test(e.logo),t=/^\./.test(e.logo);n||i||t||(e.logo=F(this.router.getBasePath(),e.logo))}o+=function(e){const n=e.name?e.name:"";return`\n    <main role="presentation">\n    <button class="sidebar-toggle" title="Press \\ to toggle" aria-label="Toggle primary navigation" aria-keyshortcuts="\\" aria-controls="__sidebar">\n      <div class="sidebar-toggle-button" aria-hidden="true">\n        <span></span><span></span><span></span>\n      </div>\n    </button>\n    <aside id="__sidebar" class="sidebar" role="none">\n      ${e.name?`\n            <h1 class="app-name"><a class="app-name-link" data-nosearch>${e.logo?`<img alt="${n}" src=${e.logo} />`:n}</a></h1>\n          `:""}\n      <div class="sidebar-nav" role="navigation" aria-label="primary">\x3c!--sidebar--\x3e</div>\n    </aside>\n  \n      <section class="content">\n        <article id="main" class="markdown-section" role="main" tabindex="-1">\x3c!--main--\x3e</article>\n      </section>\n    </main>\n  `}(e),this._renderTo(n,o,!0)}else this.rendered=!0;var i,t,o;if(e.loadNavbar){const n=g("nav")||l("nav"),i=e.mergeNavbar&&c;n.setAttribute("aria-label","secondary"),i?g(".sidebar").prepend(n):(d.prepend(n),n.classList.add("app-nav"),n.classList.toggle("no-badge",!e.repo))}e.themeColor&&u.head.appendChild(l("div",(o=e.themeColor,`<style>:root{--theme-color: ${o};}</style>`)).firstElementChild),this._updateRender(),m(d,"ready")}}}function Xe(e){return class extends e{routes(){return this.config.routes||{}}matchVirtualRoute(e){const n=this.routes(),i=Object.keys(n);let t=()=>null;function o(){const a=i.shift();if(!a)return t(null);const c=function(e){const n=e.startsWith("^")?e:`^${e}`;return n.endsWith("$")?n:`${n}$`}(a),r=e.match(c);if(!r)return o();const s=n[a];if("string"==typeof s){return t(s)}if("function"==typeof s){const n=s,[i,a]=function(){let e=()=>null;return[function(n){e(n)},function(n){e=n}]}();if(a((e=>"string"==typeof e?t(e):!1===e?t(null):o())),n.length<=2){return i(n(e,r))}return n(e,r,i)}return o()}return{then(e){t=e,o()}}}}}const Je=document.currentScript;class Ke extends(function(e){return class extends e{#d(e,n,i,t,o,a){e=a?e:e.replace(/\/$/,""),(e=z(e))&&Qe(o.router.getFile(e+i)+n,!1,o.config.requestHeaders).then(t,(a=>this.#d(e,n,i,t,o)))}#f;#g=()=>this.#f&&this.#f.abort&&this.#f.abort();#p=(e,n)=>(this.#g(),this.#f=Qe(e,!0,n),this.#f);#l=(e,n)=>{const{notFoundPage:i,ext:t}=n,o="_404"+(t||".md");let a,c;switch(typeof i){case"boolean":c=o;break;case"string":c=i;break;case"object":a=Object.keys(i).sort(((e,n)=>n.length-e.length)).filter((n=>e.match(new RegExp("^"+n))))[0],c=a&&i[a]||o}return c};_loadSideAndNav(e,n,i,t){return()=>{if(!i)return t();this.#d(e,n,i,(e=>{this._renderSidebar(e),t()}),this,!0)}}_fetch(e=t){const{query:n}=this.route;let{path:i}=this.route;if(a(i))history.replaceState(null,"","#"),this.router.normalize();else{const t=$(n,["id"]),{loadNavbar:o,requestHeaders:c,loadSidebar:r}=this.config,s=this.router.getFile(i);this.isRemoteUrl=a(s),this.isHTML=/\.html$/g.test(s);const u=(n,o,a)=>{this.route.response=a,this._renderMain(n,o,this._loadSideAndNav(i,t,r,e))},d=(n,o)=>{this.route.response=o,this._fetchFallbackPage(i,t,e)||this._fetch404(s,t,e)};this.isRemoteUrl?this.#p(s+t,c).then(u,d):this.matchVirtualRoute(i).then((e=>{"string"==typeof e?u(e):this.#p(s+t,c).then(u,d)})),o&&this.#d(i,t,o,(e=>this._renderNav(e)),this,!0)}}_fetchCover(){const{coverpage:e,requestHeaders:n}=this.config,i=this.route.query,t=z(this.route.path);if(e){let o=null;const a=this.route.path;if("string"==typeof e)"/"===a&&(o=e);else if(Array.isArray(e))o=e.indexOf(a)>-1&&"_coverpage";else{const n=e[a];o=!0===n?"_coverpage":n}const c=Boolean(o)&&this.config.onlyCover;return o?(o=this.router.getFile(t+o),this.coverIsHTML=/\.html$/g.test(o),Qe(o+$(i,["id"]),!1,n).then((e=>this._renderCover(e,c)))):this._renderCover(null,c),c}}$fetch(e=t,n=this.onNavigate.bind(this)){const i=()=>{this.callHook("doneEach"),e()};this._fetchCover()?i():this._fetch((()=>{n(),i()}))}_fetchFallbackPage(e,n,i=t){const{requestHeaders:o,fallbackLanguages:a,loadSidebar:c}=this.config;if(!a)return!1;const r=e.split("/")[1];if(-1===a.indexOf(r))return!1;const s=this.router.getFile(e.replace(new RegExp(`^/${r}`),""));return this.#p(s+n,o).then(((t,o)=>this._renderMain(t,o,this._loadSideAndNav(e,n,c,i))),(t=>this._fetch404(e,n,i))),!0}_fetch404(e,n,i=t){const{loadSidebar:o,requestHeaders:a,notFoundPage:c}=this.config,r=this._loadSideAndNav(e,n,o,i);if(c){const n=this.#l(e,this.config);return this.#p(this.router.getFile(n),a).then(((e,n)=>this._renderMain(e,n,r)),(e=>this._renderMain(null,{},r))),!0}return this._renderMain(null,{},r),!1}initFetch(){this.config,this.$fetch((e=>this.callHook("ready")))}}}(function(e){return class extends e{#v;#h;#_=u.title;initEvent(){const{topMargin:e}=this.config;e&&document.documentElement.style.setProperty("scroll-padding-top",`${e}px`),this.#m(),this.#b("#skip-to-content"),this.#k(".sidebar"),this.#w("button.sidebar-toggle"),this.#y()}#m(){const e=g("section.cover");if(!e)return void m(d,"add","sticky");new IntersectionObserver((e=>{const n=e[0].isIntersecting;m(d,n?"remove":"add","sticky")})).observe(e)}#x(){const e=p("#main :where(h1, h2, h3, h4, h5)"),n=new Set;this.#v?.disconnect(),this.#v=new IntersectionObserver((e=>{if(this.#h)return;for(const i of e){const e=i.isIntersecting?"add":"delete";n[e](i.target)}const i=n.size>1?Array.from(n).sort(((e,n)=>e.compareDocumentPosition(n)&Node.DOCUMENT_POSITION_FOLLOWING?-1:1))[0]:n.values().next().value;if(i){const e=i.getAttribute("id"),n=this.router.toURL(this.router.getCurrentPath(),{id:e}),t=this.#$(n);t?.scrollIntoView({behavior:"instant",block:"nearest",inline:"nearest"})}}),{rootMargin:"0% 0% -50% 0%"}),e.forEach((e=>{this.#v.observe(e)}))}#y(){const{keyBindings:e}=this.config,n=["alt","ctrl","meta","shift"];e&&e.constructor===Object&&(Object.values(e||[]).forEach((e=>{const{bindings:i}=e;i&&(e.bindings=Array.isArray(i)?i:[i],e.bindings=e.bindings.map((e=>{const i=[[],[]];return"string"==typeof e&&(e=e.split("+")),e.forEach((e=>{const t=n.includes(e),o=i[t?0:1],a=e.trim().toLowerCase();o.push(a)})),i.forEach((e=>e.sort())),i.flat()})))})),_("keydown",(i=>{if(document.activeElement.matches("input, select, textarea"))return;Object.values(e||[]).filter((({bindings:e})=>e&&e.some((e=>e.every((e=>n.includes(e)&&i[e+"Key"]||i.key===e||i.code.toLowerCase()===e||i.code.toLowerCase()===`key${e}`)))))).forEach((({callback:e})=>{i.preventDefault(),e(i)}))})))}#k(e){(e="string"==typeof e?document.querySelector(e):e)&&_(e,"click",(({target:e})=>{"A"===e.nodeName&&e.nextSibling&&e.nextSibling.classList&&e.nextSibling.classList.contains("app-sub-sidebar")&&m(e.parentNode,"collapse")}))}#w(e){if(!(e="string"==typeof e?document.querySelector(e):e))return;const n=()=>{d.classList.toggle("close");const n=c?d.classList.contains("close"):!d.classList.contains("close");e.setAttribute("aria-expanded",n)};_(e,"click",(e=>{e.stopPropagation(),n()})),c&&_(d,"click",(()=>d.classList.contains("close")&&n()))}#b(e){(e="string"==typeof e?document.querySelector(e):e)&&e.addEventListener("click",(e=>{e.preventDefault(),g("main")?.scrollIntoView({behavior:"smooth"}),this.#A()}))}onRender(){const e=this.router.toURL(this.router.getCurrentPath()),n=g(`.sidebar a[href='${e}']`)?.innerText;u.title=n||this.#_,this.#S(),this.#z(),this.#x()}onNavigate(e){const{auto2top:n,topMargin:i}=this.config,{query:t}=this.route;if(this.#$(),"history"!==e)if(t.id){const e=g(`.markdown-section :where(h1, h2, h3, h4, h5)[id="${t.id}"]`);e&&(this.#E(),e.scrollIntoView({behavior:"smooth",block:"start"}))}else"navigate"===e&&n&&(document.scrollingElement.scrollTop=i??0);(t.id||"navigate"===e)&&this.#A()}#A(e={}){const n={preventScroll:!0,...e},{query:i}=this.route,t=i.id?g(`#${i.id}`):g("#main :where(h1, h2, h3, h4, h5, h6)")||g("#main");t?.focus(n)}#S(){const e=decodeURIComponent(this.router.toURL(this.route.path)),n=g("nav.app-nav");if(!n)return;const i=p(n,"a").sort(((e,n)=>n.href.length-e.href.length)).find((n=>e.includes(n.getAttribute("href"))||e.includes(decodeURI(n.getAttribute("href"))))),t=g(n,"li.active");return i&&i!==t&&(t?.classList.remove("active"),i.classList.add("active")),i}#$(e){e??=this.router.toURL(this.router.getCurrentPath());const n=g(".sidebar");if(!n)return;const i=g(n,"li.active"),t=g(n,`a[href="${e}"], a[href="${decodeURIComponent(e)}"]`)?.closest("li");return t&&t!==i&&(i?.classList.remove("active"),t.classList.add("active")),t}#z(e){e??=this.router.toURL(this.route.path);const n=g(".sidebar");if(!n)return;const i=e?.split("?")[0],t=g(n,"li[aria-current]"),o=g(n,`a[href="${i}"], a[href="${decodeURIComponent(i)}"]`)?.closest("li");return o&&o!==t&&(t?.removeAttribute("aria-current"),o.setAttribute("aria-current","page")),o}#E(){document.addEventListener("scroll",(()=>{if(this.#h=!0,"onscrollend"in window)document.addEventListener("scrollend",(()=>this.#h=!1),{once:!0});else{const e=()=>{clearTimeout(n),n=setTimeout((()=>{document.removeEventListener("scroll",e),this.#h=!1}),100)};let n;document.addEventListener("scroll",e,!1)}}),{once:!0})}}}(Ye(Xe(function(e){return class extends e{route={};updateRender(){this.router.normalize(),this.route=this.router.parse(),d.setAttribute("data-page",this.route.file)}initRouter(){const e=this.config;let n;n="history"===(e.routerMode||"hash")?new q(e):new O(e),this.router=n,this.updateRender(),P=this.route,n.onchange((e=>{this.updateRender(),this._updateRender(),P.path!==this.route.path?(this.$fetch(t,this.onNavigate.bind(this,e.source)),P=this.route):this.onNavigate(e.source)}))}}}(function(e){return class extends e{_hooks={};_lifecycle={};initLifecycle(){["init","mounted","beforeEach","afterEach","doneEach","ready"].forEach((e=>{const n=this._hooks[e]=[];this._lifecycle[e]=e=>n.push(e)}))}callHook(e,n,i=t){const o=this._hooks[e],a=this.config.catchPluginErrors,c=function(e){const t=o[e];if(e>=o.length)i(n);else if("function"==typeof t){const i="Docsify plugin error";if(2===t.length)try{t(n,(i=>{n=i,c(e+1)}))}catch(n){if(!a)throw n;console.error(i,n),c(e+1)}else try{const i=t(n);n=void 0===i?n:i,c(e+1)}catch(n){if(!a)throw n;console.error(i,n),c(e+1)}}else c(e+1)};c(0)}}}(Object))))))){config=function(e){const t=Object.assign({auto2top:!1,autoHeader:!1,basePath:"",catchPluginErrors:!0,cornerExternalLinkTarget:"_blank",coverpage:"",el:"#app",executeScript:null,ext:".md",externalLinkRel:"noopener",externalLinkTarget:"_blank",formatUpdated:"",ga:"",homepage:"README.md",loadNavbar:null,loadSidebar:null,maxLevel:6,mergeNavbar:!1,name:"",nameLink:window.location.pathname,nativeEmoji:!1,noCompileLinks:[],noEmoji:!1,notFoundPage:!1,plugins:[],relativePath:!1,repo:"",routes:{},routerMode:"hash",subMaxLevel:0,topMargin:0,__themeColor:"",get themeColor(){return this.__themeColor},set themeColor(e){e&&(this.__themeColor=e,console.warn(He("\n              $docsify.themeColor is deprecated. Use a --theme-color property in your style sheet. Example:\n              <style>\n                :root {\n                  --theme-color: deeppink;\n                }\n              </style>\n            ").trim()))}},"function"==typeof window.$docsify?window.$docsify(e):window.$docsify);!1!==t.keyBindings&&(t.keyBindings=Object.assign({toggleSidebar:{bindings:["\\"],callback(e){const n=document.querySelector(".sidebar-toggle");n&&(n.click(),n.focus())}}},t.keyBindings));const o=Je||Array.from(document.getElementsByTagName("script")).filter((e=>/docsify\./.test(e.src)))[0];if(o)for(const e of Object.keys(t)){const a=o.getAttribute("data-"+n(e));i(a)&&(t[e]=""===a||a)}return!0===t.loadSidebar&&(t.loadSidebar="_sidebar"+t.ext),!0===t.loadNavbar&&(t.loadNavbar="_navbar"+t.ext),!0===t.coverpage&&(t.coverpage="_coverpage"+t.ext),!0===t.repo&&(t.repo=""),!0===t.name&&(t.name=""),window.$docsify=t,t}(this);constructor(){super(),this.initLifecycle(),this.initPlugin(),this.callHook("init"),this.initRouter(),this.initRender(),this.initEvent(),this.initFetch(),this.callHook("mounted")}initPlugin(){this.config.plugins.forEach((e=>{try{o(e)&&e(this._lifecycle,this)}catch(e){if(!this.config.catchPluginErrors)throw e;{const n="Docsify plugin error";console.error(n,e)}}}))}}var en=Object.freeze({__proto__:null,cached:e,cleanPath:E,getParentPath:z,getPath:F,hyphenate:n,inBrowser:!0,isAbsolutePath:A,isExternal:a,isFn:o,isMobile:c,isPrimitive:i,noop:t,parseQuery:x,removeParams:S,replaceSlug:C,resolvePath:T,stringifyQuery:$});window.Docsify={util:en,dom:k,get:Qe,slugify:Le,version:"4.13.0"},window.DocsifyCompiler=Ne,window.marked=xe,window.Prism=Pe,b((()=>new Ke))}();
